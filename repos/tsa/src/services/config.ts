...
import { ConfigPath, ConfigDir, ProjectConfig } from '@TSA/constants/paths'
...
export class ConfigService {
  ...
  static loadGlobal(): TTsaConfig {
    return ConfigService.#loadYaml<TTsaConfig>(ConfigPath) ?? {}
  }

  static saveGlobal(config: TTsaConfig): void {
  ...
  static merge(global: TTsaConfig, project: TProjectConfig): TTsaConfig {
    return {
      ...global,
