...
describe(`sessions share task`, () => {
  ...
  it(`resolveSessionId resolves, changeVisibility resolves -- calls changeVisibility with the resolved sessionId and 'public', does not exit`, async () => {
