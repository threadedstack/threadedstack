...
export const getKubeMeta = (props: TTaskActionArgs, throwErr: boolean = true) => {
  ...
  throwErr &&
    ...
    !kubeContext &&
    taskError(
      `The "TDSK_KUBE_CONTEXT" and "TDSK_KUBE_NAMESPACE" envs are required to run devspace commands`
    )
