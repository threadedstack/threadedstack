...
export const devspace = {
  start: dsdefaults(async (props:TTaskActionArgs) => await cmd({
    ...cmdOpts(props),
  ...
  render: dsdefaults(async (props:TTaskActionArgs) => await cmd({
    ...cmdOpts(props),
    args: [...(props?.params?.dsargs || []), `deploy`, `--render`, `--skip-build`]
  })),
  logs: dsdefaults(async (props:TTaskActionArgs) => await cmd({
    ...cmdOpts(props),
    args: [...(props?.params?.dsargs || []), `logs`, ...selector(props)]
  }), {
    follow: `--follow`,
  }),
  attach: dsdefaults(async (props:TTaskActionArgs) => await cmd({
    ...cmdOpts(props),
    args: [...(props?.params?.dsargs || []), `attach`, ...selector(props)]
  })),
  enter: dsdefaults(async (props:TTaskActionArgs) => await cmd({
    ...cmdOpts(props),
    args: [...(props?.params?.dsargs || []), `enter`, props.params.cmd || ``, ...selector(props)]
  })),
  purge: dsdefaults(async (props:TTaskActionArgs) => await cmd({
    ...cmdOpts(props),
    args: [...(props?.params?.dsargs || []), ...purge(props)],
  })),
  clean: dsdefaults(async (props:TTaskActionArgs) => await cmd({
    ...cmdOpts(props),
