...
export const ResourceScope: Record<EPermResource, EPermScope> = {
  ...
  [EPermResource.taskProposal]: EPermScope.project,
  [EPermResource.escalation]: EPermScope.project,
  [EPermResource.verification]: EPermScope.project,
  [EPermResource.opsAction]: EPermScope.project,
