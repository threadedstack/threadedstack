...
export const EscalationIdPrefix = `es_`
export const DecisionProposalIdPrefix = `dp_`
export const DecisionPositionIdPrefix = `dpos_`
export const CompanyStrategyIdPrefix = `cs_`
