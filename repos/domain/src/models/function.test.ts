  ...
  describe(`constructor`, () => {
    it(`should create a function with required fields`, () => {
      const functionData = {
        ...
        content: `export default function handler(req, res) { return res.json({ success: true }) }`,
    ...
    it(`should create a function with all optional fields`, () => {
      const functionData = {
        ...
        endpointId: `456e4567-e89b-12d3-a456-426614174001`,
        projectId: `789e4567-e89b-12d3-a456-426614174002`,
        content: `export default function handler(req, res) { return res.json({ data: req.body }) }`,
        language: `python`,
        defaultArgs: {
          timeout: 5000,
          retryCount: 3,
...
export default async function handler(req: Request, res: Response) {
  ...
  describe(`nullability for DB-nullable fields`, () => {
    it(`should create a function without endpointId (undefined is ok)`, () => {
      const functionData = {
        id: `123e4567-e89b-12d3-a456-426614174000`,
        projectId: `789e4567-e89b-12d3-a456-426614174002`,
        content: `export default function handler(req, res) { return res.json({ success: true }) }`,
