...
vi.mock(`@TAF/components/Login/GithubBtn`, () => ({
  GhButton: (props: any) => (
    <button
      data-testid='gh-btn'
...
vi.mock(`@TAF/components/Login/GoogleBtn`, () => ({
  GgButton: (props: any) => (
    <button
      data-testid='gg-btn'
...
vi.mock(`@TAF/components/Login/VercelBtn`, () => ({
  VrButton: (props: any) => (
    <button
      data-testid='vr-btn'
...
vi.mock(`@TAF/components/Login/EmailLoginForm`, () => ({
