import type { TDocument, TModeContext, TContentNode, TTokenizeResult } from '@TTH/types'

import { detectMode } from '@TTH/services/gui/parser/modeDetector'
import { parseScopes } from '@TTH/services/gui/parser/scopeParser'
