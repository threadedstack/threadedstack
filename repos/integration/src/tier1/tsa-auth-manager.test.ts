...
/**
 * Tier 1: TSA AuthManager — Live Proxy Validation
 *
 * Tests the TSA's AuthManager.login() against the live K8s proxy.
...
import { AuthManager } from '@tdsk/tsa/services/auth'

describe('Tier 1: TSA AuthManager (live)', () => {
