...
import { validateObject, validateOneOf, validateString } from '../validators'
...
import { customInspectSymbol as kInspect } from '../util'
...
class KeyObject /* extends NativeKeyObject*/ {
  ...
  equals(otherKeyObject) {
    ...
    return (
      otherKeyObject.type === this.type && this[kHandle].equals(otherKeyObject[kHandle])
    )
  }
}
