...
import { addAbortSignalNoValidate } from './add-abort-signal'
import { Buffer } from 'buffer'
import { debuglog } from '../util/debuglog'
import { getDefaultHighWaterMark, getHighWaterMark } from './state'
import { prependListener, Stream } from './legacy'
...
import destroyImpl from './destroy'
...
Object.defineProperties(Readable.prototype, {
  readable: {
    get() {
      ...
      // deprecated setter.
      return (
        !!r && r.readable !== false && !r.destroyed && !r.errorEmitted && !r.endEmitted
      )
    },
    set(val) {
      // Backwards compat.
