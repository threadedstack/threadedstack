...
import { isIterable, isNodeStream, isReadableNodeStream } from './utils'
import { once } from '../util'
import { validateAbortSignal, validateCallback } from '../validators'
import {
  AbortError,
  aggregateTwoErrors,
...
function destroyer(stream, reading, writing, callback) {
  ...
  eos(stream, { readable: reading, writable: writing }, (err) => {
    ...
    if (
      ...
      reading &&
      rState && rState.ended && !rState.errored &&
      !rState.errorEmitted
    ) {
