...
export { memories, memoriesRelations } from '@TDB/schemas/memories'
export { records, recordsRelations } from '@TDB/schemas/records'
export { collections, collectionsRelations } from '@TDB/schemas/collections'
...
export {
  decisionProposals,
  decisionProposalsRelations,
} from '@TDB/schemas/decisionProposals'
export {
  decisionPositions,
